...
%_____________________set processing flags______________________
   ...
   CompassOffset = 21.4; % exact value from calibration file
                        % (no sign changes!)
   DeployDecl = -1.07; % at deployment location
   CorvallisDecl = 15+44/60; % at corvallis

   % chipod location (positive North, East & Down)
   ChipodLon = 90; ChipodLat = 12; ChipodDepth = 30;
   ...
   if use_rama
       ramaname = '~/rama/RamaPrelimProcessed/RAMA14-12N-corrected.mat';
   end
